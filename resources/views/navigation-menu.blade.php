...
<body>
    <!-- Header -->
    <header class="fixed top-0 left-0 w-full shadow-md py-4 header-bg h-20 z-20 header-bg">
        <div class="container mx-a<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
...
</html>uto flex justify-between items-center px-6">
            <!-- Logo -->
            <a href="{{ url('/') }}" class="text-2xl font-bold text-white">
                GOLDEN GLOW
            </a>
