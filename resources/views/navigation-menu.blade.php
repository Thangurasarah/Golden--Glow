            ...
            <a href="{{ url('/') }}" class="text-2xl font-bold text-white">
                ...
                <div class="container mx-auto flex justify-between items-center px-6">
                    ...
                    <nav class="hidden md:flex space-x-6">
                        ...
                        <a href="{{ url('/contact') }}"
                            class="text-white hover:text-pink-500 transition">ACCESSORIES</a>
                    </nav>
                    ...
                    <div class="flex items-center space-x-4">
                        <a href="{{ url('/cart') }}" class="relative">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-6 w-6 text-white hover:text-pink-500 transition" viewBox="0 0 24 24"
                        ...
                        <!-- Navigation Links -->
                        <nav class="hidden md:flex space-x-6">
                            <a href="{{ url('/') }}" class="text-white hover:text-pink-500 transition">SHOP
                                ALL</a>
                            <a href="{{ url('/shop') }}" class="text-white hover:text-pink-500 transition">FACE</a>
                            <a href="{{ url('/about') }}" class="text-white hover:text-pink-500 transition">LIPS</a>
                            <a href="{{ url('/contact') }}" class="text-white hover:text-pink-500 transition">EYES</a>
                        ...
                        <div class=" flex items- center space-x-8">
                            @guest
                                <a href="{{ url('/login') }}" class="text-white hover:text-pink-500 transition">Login</a>
                                <a href="{{ url('/register') }}" class="text-white hover:text-pink-500 transition">Sign
                                    Up</a>
                            @endguest
                            @auth
                                <a href="{{ route('profile.show') }}"
                                    class="text-white hover:text-pink-500 transition">Profile</a>
                    ...
                    <div id="mobile-menu" class="hidden md:hidden bg-white shadow-md">
                        <a href="{{ url('/') }}"
                            class="block px-6 py-2 text-gray-700 hover:text-pink-500">Home</a>
                        <a href="{{ url('/shop') }}"
                            class="block px-6 py-2 text-gray-700 hover:text-pink-500">Shop</a>
                        <a href="{{ url('/about') }}"
                            class="block px-6 py-2 text-gray-700 hover:text-pink-500">About</a>
                        <a href="{{ url('/contact') }}"
                            class="block px-6 py-2 text-gray-700 hover:text-pink-500">Contact</a>
                        <a href="{{ route('profile.show') }}"
                            class="block px-6 py-2 text-gray-700 hover:text-pink-500">Profile</a>
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="btn btn-danger">Logout</button>
                        </form>
